...
if($subfield8===""){
 $showpage=file_get_contents('thanks.html');
}

if($subfield8==="boy"){
 $showpage=file_get_contents('http://guilefulmagic.com/landing/boy_thank_you');
}
if($subfield8==="girl"){
...
$showpage=str_replace("MkpWf1gK31rksg4",$subname,$showpage);
$showpage=str_replace("y4MIIQ1ei3hGq6H",$subemail,$showpage);
$showpage=str_replace("4W384A5tbs4Qqrd",$subfield9,$showpage);
$showpage=str_replace("Fbrk9sm5iJlj4ty",$subtomorrow,$showpage);
