...
$domain = array(
			1	=>	'http://thebrilliantballoonman.com/',	// put your primary website domain here between the ' marks. Keep the / at the end
...
if ( $showpage === false || $showpage === "" ) {
	echo "Requested file appears to not have any content! <a href=\"$l\">Click here</a> to see if the file really exists.";
};
...
echo "<!-- Amazing System's master.php changed $changecount merge codes. -->\n";
echo $showpage;	//show the final content
echo "<!-- Template File: $l -->\n";
exit(); // shut 'er down
